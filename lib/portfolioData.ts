...
export const portfolioCases: PortfolioCase[] = [
  ...
  // ─── 4. 美妝廣告 ──────────────────────────────────────────
  {
    ...
    challenge:
      "品牌在港零認知，競爭極激烈（美妝廣告 CPM 高達 HK$300+）；產品定價偏高端（HK$380-680），需觸及真正有購買意願的高消費力受眾；創意素材缺乏本地化，轉換率低。",
    solution:
  ...
  // ─── 5. 企業官網 ──────────────────────────────────────────
  {
    ...
    outcome:
      "上線後網站載入速度從 8 秒降至 1.4 秒，月均詢盤數量從 12 件增至 54 件，詢盤至簽約轉換率提升 45%，銷售週期縮短 30%。",
    stats: "+45%",
    statLabel: "詢價轉換率",
    resultMetrics: [
      { label: "詢盤轉換率", value: "+45%", description: "詢盤至成交比率", highlight: true },
  ...
  // ─── 6. WhatsApp 自動化 ───────────────────────────────────
  {
    ...
    fullDescription:
      "荃灣一間主打 DSE 英文科的補習中心，面臨三大痛點：學生 No-show 率高達 25%（每節課損失實際收入）；人工電話提醒耗費大量行政時間；潛在學生查詢後跟進不及時，轉換率低。ADWire 為其設計基於 WhatsApp Business API 的全自動化溝通系統。",
    challenge:
    ...
    outcome:
      "No-show 率從 25% 降至 8%，每月挽回損失收入約 HK$12,000；行政時間節省 12 小時/週；新生查詢 3 日內轉換率提升 75%。",
    stats: "95%",
    statLabel: "訊息打開率",
    resultMetrics: [
  ...
  // ─── 11. 美食短視頻 ───────────────────────────────────────
  {
    ...
    fullDescription:
      "一個由家庭主婦創辦的香港本地醬料品牌，以阿媽秘方為賣點，產品質素受身邊朋友一致好評，但缺乏規模化的品牌曝光渠道，IG 追蹤者長期停留在 300 人以下。ADWire 為其策劃系列化美食短視頻計劃，以極速美食製作為核心賣點打入 TikTok 及 IG Reels 演算法推薦流。",
    challenge:
      "品牌完全無網上知名度，預算極有限（HK$15,000 以內）；內容同質化嚴重，難以在大量美食帳號中突圍；需要同時在 TikTok 及 IG 兩個平台起效，且目標受眾不同（TK 偏向年輕族群，IG 偏向 25-35 歲主婦）。",
    solution:
      "策略核心：將醬料品牌定位為「懶人料理神器」，而非傳統「家庭廚房用品」。製作格式統一的 15 秒「一招搞掂」系列：每條片只示範一道菜，前 3 秒必有強烈視覺鉤子（熱油爆香特寫、奶酪拉絲 ASMR），字幕強調省時效益。TikTok 版本側重快節奏剪接與流行音效；IG 版本增加美食氛圍感。系列採用開放式結尾，鼓勵用戶評論「下一道菜是什麼」，持續推動演算法互動。",
    outcome:
    ...
    processSteps: [
      ...
      { phase: "第 3-4 週", title: "發佈測試與演算法學習", description: "每 2-3 天發佈一條，監控各條片的演算法表現，分析高互動元素。" },
  ...
  // ─── 13. AI 辦公效率工具 ──────────────────────────────────────
  {
    ...
    processSteps: [
      ...
      { phase: "第 3-4 週", title: "員工測試與迭代", description: "選取 3 名員工進行真實工作場景測試，收集回饋持續優化提示詞與介面，確保非技術用戶也能輕鬆使用。" },
  ...
  // ─── 14. 小紅書種草 ───────────────────────────────────────────
  {
    ...
    fullDescription:
      "一個在香港及澳門擁有口碑的本地美妝品牌，希望借助小紅書龐大的美妝用戶社群打入內地市場。品牌方自行在小紅書開設帳號已有半年，但粉絲成長停滯（不足 800 人），筆記互動極低，完全不了解小紅書的「種草文化」與演算法邏輯。ADWire 憑藉深厚的內地平台運營經驗，為品牌制訂系統化小紅書種草策略。",
    challenge:
    ...
    processSteps: [
      ...
      { phase: "第 4-10 週", title: "分批發佈與演算法激活", description: "首週素人批量發佈建立基礎聲量，第二週腰部達人跟進提升可信度，第三週頭部 KOL 加倉放大效應。" },

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `與 ADWire 合作非常簡單，只需四個步驟：①通過 WhatsApp (${WHATSAPP_E164}) 或網站聯絡表格與我們聯繫；②我們的專家團隊安排 15 分鐘免費業務診斷，了解您的需求與目標；③根據分析結果量身定制 MarTech 方案並確認合作細節；④正式執行，全程提供數據報告與優化建議。我們會由專人跟進，並盡快回覆你的查詢。`,
  },
  {
